...
fighter1.addAnimation("slide2", f1_slide)
fighter1.addAnimation("dead2", f1_dead)
fighter1.addAnimation("d2", dead1)
fighter1.addAnimation("a2", f1_a1)
...
fighter2.addAnimation("slide", f2_slide)
fighter2.addAnimation("rSlide", f2_reverseSlide)
...
image(bg, 0,0, displayWidth-20, displayHeight-30)
    ...
    if(keyWentDown(DOWN_ARROW)){
        fighter2.changeAnimation("rSlide", f2_reverseSlide)
        fighter2.velocityX=2
    }
